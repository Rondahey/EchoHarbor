...
export default function EchoHarbor() {
  ...
  async function runCheck() {
    setStatus("Pulling data from Base…");
  ...
  return (
    <OnchainKitProvider chain={chain}>
      <div style={{ maxWidth: 900, margin: "44px auto", fontFamily: "system-ui" }}>
        <h1>EchoHarbor — Built for Base</h1>
        <p style={{ marginTop: 8 }}>
          Minimal Base connectivity probe using OnchainKit wallet UX and Viem JSON-RPC reads.
        </p>
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "center", marginTop: 14 }}>
          ...
          <button onClick={runCheck} style={{ padding: "6px 12px" }}>
            Run Probe
          </button>
